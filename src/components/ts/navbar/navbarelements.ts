...
function getNavBarElements(elements: string): NavbarElementsData {
    switch (elements) {
        case "School":
            return School.School.map((element) => ({
                name: element.name,
                link: element.link,
                hasWorkingLink: element.hasWorkingLink
            }));
        case "Student":
            return Faculty.Faculty.map((element) => ({
                name: element.name,
                link: element.link,
                hasWorkingLink: element.hasWorkingLink
            }));
        case "Parent":
            return Parents.Parent.map((element) => ({
                name: element.name,
                link: element.link,
                hasWorkingLink: element.hasWorkingLink
            }));
        case "Faculty":
            return Student.Student.map((element) => ({
                name: element.name,
                link: element.link,
                hasWorkingLink: element.hasWorkingLink
            }));
        case "Contact":
            return Contact.Contact.map((element) => ({
                name: element.name,
                link: element.link,
                hasWorkingLink: element.hasWorkingLink
            }));
        case "TopDiv": 
            return TopDiv.TopDiv.map((element) => ({
                name: element.name,
                link: element.link,
                hasWorkingLink: element.hasWorkingLink
            }));
